...
void wxC9ED9InitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/wxcrafter_bitmaps.cpp$D__Project_CPrice_wxcrafter_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/wxcrafter_bitmaps.cpp$D__Project_CPrice_wxcrafter_bitmaps.xrc"));
}
